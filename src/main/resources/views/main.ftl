        ...
        <div class="layui-side-scroll layui-left-menu">
                <ul class="layui-nav layui-nav-tree layui-left-nav-tree layui-this" id="currency">
                        ...
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <#if grantCode?seq_contains("1010")>
                                    <dd>
                                ...
                                <#if grantCode?seq_contains("1020")>
                                    <dd>
                        ...
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <#if grantCode?seq_contains("2010")>
                                    <dd>
                                ...
                                <#if grantCode?seq_contains("2020")>
                                    <dd>
                        ...
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <#if grantCode?seq_contains("3010")>
                                    <dd>
                                ...
                                <#if grantCode?seq_contains("3020")>
                                    <dd>
                                ...
                                <#if grantCode?seq_contains("3030")>
                                    <dd>
                                ...
                                <#if grantCode?seq_contains("3040")>
                                    <dd>
                                ...
                                <#if grantCode?seq_contains("3050")>
                                    <dd>
                        ...
                        <a href="javascript:;" class="layui-menu-tips"><i class="fa fa-home"></i><span class="layui-left-nav"> 统计报表</span> <span class="layui-nav-more"></span></a>
                            <dl class="layui-nav-child">
                                <#if grantCode?seq_contains("4010")>
                                <dd>
                                ...
                                <#if grantCode?seq_contains("4020")>
                                <dd>
                                ...
                                <#if grantCode?seq_contains("4030")>
                            <dd>
                                ...
                                <#if grantCode?seq_contains("4040")>
                            <dd>
                        ...
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <#if grantCode?seq_contains("6040")>
                                <dd>
                                ...
                                <#if grantCode?seq_contains("6010")>
                                    <dd>
                                ...
                                <#if grantCode?seq_contains("6020")>
                                    <dd class="">
                                ...
                                <#if grantCode?seq_contains("6050")>
                                    <dd class="">
